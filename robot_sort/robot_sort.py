class SortingRobot:
    def __init__(self, l):
        ...
        self._item = self._list[0] # The item the robot is holding
    ...
    # I understand this probably isn't the intended solution. Plan to come
    # back to this after finishing exercise II of the questions.
    def sort(self):
        self.set_light_on()

        while self.light_is_on():
            self.set_light_off()
            for self._position in range(0, len(self._list) - 1):
